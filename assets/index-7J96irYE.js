 ...
 */var Lg;function vS(){if(Lg)return mo;Lg=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:o,type:r,key:h,ref:l!==void 0?l:null,props:c}}return mo.Fragment=e,mo.jsx=i,mo.jsxs=i,mo}var Ng;function SS(){return Ng||(Ng=1,bf.exports=vS()),bf.exports}var Qi=SS(),Af={exports:{}},se={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`)}function XT(o,e){let i;switch(e){case QS:i="Linear";break;case JS:i="Reinhard";break;case $S:i="Cineon";break;case tx:i="ACESFilmic";break;case nx:i="AgX";break;case ix:i="Neutral";break;case ex:i="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),i="Linear"}return"vec3 "+o+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const uu=new rt;function WT(){Ee.getLuminanceCoefficients(uu);const o=uu.x.toFixed(4),e=uu.y.toFixed(4),i=uu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function tb(o){let e="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===I_?e="SHADOWMAP_TYPE_PCF":o.shadowMapType===DS?e="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===Zi&&(e="SHADOWMAP_TYPE_VSM"),e}function eb(o){let e="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case ms:case gs:e="ENVMAP_TYPE_CUBE";break;case xu:e="ENVMAP_TYPE_CUBE_UV";break}return e}function nb(o){let e="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case gs:e="ENVMAP_MODE_REFRACTION";break}return e}function ib(o){let e="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case F_:e="ENVMAP_BLENDING_MULTIPLY";break;case KS:e="ENVMAP_BLENDING_MIX";break;case jS:e="ENVMAP_BLENDING_ADD";break}return e}function ab(o){const e=o.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function rb(o,e,i,r){const l=o.getContext(),c=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=tb(i),p=eb(i),g=nb(i),v=ib(i),x=ab(i),y=qT(i),A=YT(c),R=l.createProgram();let M,_,G=i.glslVersion?"#version "+i.glslVersion+`
...
`;function z_(o){let e=parseInt(o.replace("#",""),16),i=(e>>16&255)/255,r=(e>>8&255)/255,l=(e&255)/255;return[i,r,l]}function Bb(){const o=gu.useRef();return Qi.jsx("div",{ref:o,className:"back",children:Qi.jsx(Ob,{frag:Pb,parent:o,uniforms:{u_colorA:{value:new rt(...z_("#2b0c2e"))},u_colorB:{value:new rt(...z_("#181425"))}},className:"sky"})})}window.global=window;RS.createRoot(document.getElementById("root")).render(Qi.jsx(gu.StrictMode,{children:Qi.jsx(zb,{z:0,children:Qi.jsx(Bb,{})})}));function zb({z:o=0,children:e}){return Qi.jsx(Qi.Fragment,{children:Qi.jsx("div",{className:"layer",style:{zIndex:o},id:`layer-${o}`,children:e})})}
